...
Install using the standard methods for a redmine plugin. However testing is showing if the web server is restarted it's not necessary to run the plugin migrations.
